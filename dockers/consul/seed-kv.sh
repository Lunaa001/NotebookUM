...
put_kv "config/controller-service/REDIS_URL"             "redis://redis-controller:6379"
put_kv "config/controller-service/REDIS_PASSWORD"        ""
...
put_kv "config/summary-service/REDIS_HOST"           "redis-summary"
put_kv "config/summary-service/REDIS_PORT"           "6379"
put_kv "config/summary-service/REDIS_PASSWORD"       ""
# Traefik tags
...
put_kv "config/persistence-service/REDIS_HOST"       "redis-persistence"
...
echo "  Verificar en: ${CONSUL_ADDR}/ui/dc-converter/kv"
echo "═══════════════════════════════════════════════════════════"
