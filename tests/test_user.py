...
class TestUser(unittest.TestCase):
    ...
    def test_create_user_returns_created_user(self, repo_cls, hash_mock):
    ...
    @patch("app.services.user_service.UserRepository")
    def test_create_user_rejects_duplicate_email(self, repo_cls):
        repo = repo_cls.return_value
    ...
    @patch("app.services.user_service.UserRepository")
    def test_get_user_by_id_returns_user(self, repo_cls):
        repo = repo_cls.return_value
    ...
    @patch("app.services.user_service.UserRepository")
    def test_get_user_by_id_raises_error_when_not_found(self, repo_cls):
        repo = repo_cls.return_value
    ...
    @patch("app.services.user_service.UserRepository")
    def test_update_user_updates_data_and_returns_user(self, repo_cls, hash_mock):
        repo = repo_cls.return_value
    ...
    @patch("app.services.user_service.UserRepository")
    def test_delete_user_is_not_allowed(self, repo_cls):
        repo = repo_cls.return_value
        service = UserService()
